...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div id="category" style="padding:20px 10px 0px 10px;">
                ...
                <div class="modal fade" id="AdminModal" tabindex="-1" role="dialog" aria-labelledby="cateModalLabel" aria-hidden="true">
    ...
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/tempusdominus-bootstrap-4/5.2.0/js/tempusdominus-bootstrap-4.min.js">
    </script>
    <!-- Summernote 0.8.18 -->
